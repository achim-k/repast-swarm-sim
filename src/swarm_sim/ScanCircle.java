...
public class ScanCircle {
    ...
    public ScanCircle(int bins, int inputsUntilValid, double mergeFactor,
	    AttractionType attrType, DistributionType distType,
	    GrowingDirection growDirection, double minCircleDistance,
	    double maxCircleDistance, double minValue, double maxValue) {
	this.bins = bins;
    ...
    public ScanCircle(int bins, int inputsUntilValid, double mergeFactor,
	    AttractionType attrType, DistributionType distType,
	    double minCircleDistance, double maxCircleDistance, double value) {
	this.bins = bins;
	this.lowerValidLImit = inputsUntilValid;
	this.mergeFactor = mergeFactor;
	this.attrType = attrType;
    ...
    public ScanCircle(int bins, int lowerValidLimit, int upperValidLimit,
	    double mergeFactor, AttractionType attrType,
     ...
     * @return
     */
    public static ScanCircle merge(int bins, double surpressRandom,
	    ScanCircle... scans) {
